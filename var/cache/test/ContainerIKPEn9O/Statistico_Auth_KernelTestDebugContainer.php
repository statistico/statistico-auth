 ...
 * @final
 */
class Statistico_Auth_KernelTestDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            'Statistico\\Auth\\Application\\Http\\HealthCheck\\Controller\\HealthCheckController' => 'getHealthCheckControllerService',
            'Statistico\\Auth\\Application\\Http\\HomeController' => 'getHomeControllerService',
            'Statistico\\Auth\\Domain\\User\\Persistence\\UserRepository' => 'getUserRepositoryService',
            'Statistico\\Auth\\Framework\\Time\\Clock' => 'getClockService',
    ...
    /**
     * Gets the public 'Statistico\Auth\Application\Http\HealthCheck\Controller\HealthCheckController' shared autowired service.
     *
     * @return \Statistico\Auth\Application\Http\HealthCheck\Controller\HealthCheckController
     */
    protected function getHealthCheckControllerService()
    {
        include_once \dirname(__DIR__, 4).'/src/Application/Http/HealthCheck/Controller/HealthCheckController.php';

        return $this->services['Statistico\\Auth\\Application\\Http\\HealthCheck\\Controller\\HealthCheckController'] = new \Statistico\Auth\Application\Http\HealthCheck\Controller\HealthCheckController();
    }

    /**
     * Gets the public 'Statistico\Auth\Application\Http\HomeController' shared autowired service.
     *
     * @return \Statistico\Auth\Application\Http\HomeController
     */
    protected function getHomeControllerService()
    {
        include_once \dirname(__DIR__, 4).'/src/Application/Http/HomeController.php';

        return $this->services['Statistico\\Auth\\Application\\Http\\HomeController'] = new \Statistico\Auth\Application\Http\HomeController();
    }

    /**
     * Gets the public 'Statistico\Auth\Domain\User\Persistence\UserRepository' shared autowired service.
     *
     * @return \Statistico\Auth\Domain\User\Persistence\DatabaseUserRepository
     */
    protected function getUserRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/src/Domain/User/Persistence/UserRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Domain/User/Persistence/DatabaseUserRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Framework/Time/Clock.php';
        include_once \dirname(__DIR__, 4).'/src/Framework/Time/SystemClock.php';

        return $this->services['Statistico\\Auth\\Domain\\User\\Persistence\\UserRepository'] = new \Statistico\Auth\Domain\User\Persistence\DatabaseUserRepository(($this->services['doctrine.dbal.default_connection'] ?? $this->getDoctrine_Dbal_DefaultConnectionService()), ($this->services['Statistico\\Auth\\Framework\\Time\\Clock'] ?? ($this->services['Statistico\\Auth\\Framework\\Time\\Clock'] = new \Statistico\Auth\Framework\Time\SystemClock())));
    }

    /**
     * Gets the public 'Statistico\Auth\Framework\Time\Clock' shared autowired service.
     *
     * @return \Statistico\Auth\Framework\Time\SystemClock
     */
    protected function getClockService()
    {
        include_once \dirname(__DIR__, 4).'/src/Framework/Time/Clock.php';
        include_once \dirname(__DIR__, 4).'/src/Framework/Time/SystemClock.php';

        return $this->services['Statistico\\Auth\\Framework\\Time\\Clock'] = new \Statistico\Auth\Framework\Time\SystemClock();
    }
    ...
    protected function getCache_AppService()
    {
        ...
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('kOp6IMvR1V', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    protected function getCache_SystemService()
    {
        ...
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('khrh74x71k', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        }, 3), true, ($this->targetDir.''.'/Statistico_Auth_KernelTestDebugContainerDeprecations.log'));
    }
    ...
    protected function getServicesResetterService()
    {
        ...
        return $this->services['services_resetter'] = new \Symfony\Component\HttpKernel\DependencyInjection\ServicesResetter(new RewindableGenerator(function () {
            ...
            return 0 + (int) (isset($this->services['cache.app'])) + (int) (isset($this->services['cache.system'])) + (int) (false) + (int) (false) + (int) (isset($this->privates['cache.annotations'])) + (int) (false) + (int) (false) + (int) (isset($this->privates['debug.stopwatch'])) + (int) (isset($this->services['event_dispatcher'])) + (int) (isset($this->services['doctrine']));
        }), ['cache.app' => [0 => 'reset'], 'cache.system' => [0 => 'reset'], 'cache.validator' => [0 => 'reset'], 'cache.serializer' => [0 => 'reset'], 'cache.annotations' => [0 => 'reset'], 'cache.property_info' => [0 => 'reset'], 'cache.messenger.restart_workers_signal' => [0 => 'reset'], 'debug.stopwatch' => [0 => 'reset'], 'debug.event_dispatcher' => [0 => 'reset'], 'doctrine' => [0 => 'reset']]);
    }
    ...
    protected function getTest_PrivateServicesLocatorService()
    {
        return $this->services['test.private_services_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'Statistico\\Auth\\Domain\\User\\Persistence\\DatabaseUserRepository' => ['services', 'Statistico\\Auth\\Domain\\User\\Persistence\\UserRepository', 'getUserRepositoryService', false],
            'Statistico\\Auth\\Framework\\Time\\SystemClock' => ['services', 'Statistico\\Auth\\Framework\\Time\\Clock', 'getClockService', false],
            ...
            'Statistico\\Auth\\Domain\\User\\Persistence\\DatabaseUserRepository' => '?',
            'Statistico\\Auth\\Framework\\Time\\SystemClock' => '?',
    ...
    protected function getCache_AnnotationsService()
    {
        ...
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('SsaElPn8Eg', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'debug.container.dump': $value = ($this->targetDir.''.'/Statistico_Auth_KernelTestDebugContainer.xml'); break;
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.container_class' => 'Statistico_Auth_KernelTestDebugContainer',
